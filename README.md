<img src="notebooks/images/DBNcare.svg" alt="DBNCare package logo" width="227" height="227"/>
...
|---------------------|----------|------------|-----------|
| Missing Values      | ❌       | ❌         | ❌        |
| Parameter Learning  | ✔️       | ✔️         | ✔️        |
| Structure Learning  | ✔️       | ✔️         | ✔️        |
| Exact Inference     | ✔️       | ✔️         | ✔️        |
| Approximate Inference| ✔️      | ✔️         | ✔️        |
| Forecasting          | ✔️      | ✔️         | ✔️        |
| Sampling             | ✔️      | ✔️         | ✔️        |
